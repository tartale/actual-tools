...
- [FIRE dashboard](fire_dashboard.md) — `./actual report fire`/`./actual accounts classify`, built on Actual's own native dashboard widgets, not reimplemented FIRE math

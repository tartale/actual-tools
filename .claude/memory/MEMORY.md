...
- [FIRE dashboard](fire_dashboard.md) — `./actual reports fire`/`./actual accounts classify` (interactive), built on Actual's own native dashboard widgets, not reimplemented FIRE math
